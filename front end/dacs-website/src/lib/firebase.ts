/*
 * Firebase web client for the customer/farmer website. Client-side only —
 * every entry point guards on `typeof window` because the Next.js build
 * also evaluates modules on the server.
 *
 * Config comes from .env.local (NEXT_PUBLIC_FIREBASE_*), same public
 * client config as front end/dacs-admin.
 */
